                ...
                <div className="flex-1 lg:ps-[5.75rem] justify-center items-center min-h-[18.75rem] flex">
                    {isActiveTab === 1 && (
                        <p className='text-[1.125rem] leading-[1.625rem] font-normal lg:text-start text-center'>
                            <strong className='font-semibold'>The certified Digital Marketing</strong>  Agency status allows us to give businesses the power to achieve online potential. Our official certification reflects the most up to date best practices in the industry, including data driven SEO and focused PPC campaigns as well as storytelling on social media and conversion-oriented content strategy. Our trained professionals leverage the best of the available tools with in-depth market acumen to deliver quantifiable ROI, increase brand awareness, and foster sustainable customer loyalty. No matter whether you are a young startup or a developed company our personalized digital solutions will make sure that your message is interesting, visible to your target audience, and allows turning interaction into profit. Become a TechDevise partner--certification and innovation in one, your digital dreams in reality.
                        </p>
                    )}
                    {isActiveTab === 2 && (
                        <p className='text-[1.125rem] leading-[1.625rem] font-normal lg:text-start text-center'>
                         <strong className='font-semibold'>At TechDevise</strong>  , we understand that technology does not work on a 9-to-5 time basis-neither do we. The 24*7 support service will guarantee that professional support can be obtained at any time of day and at any time zone. It could be a technical problem that has come out of the blue, troubleshooting that needs immediate attention, upgrading of serious updates, or even addressing your questions; our support team is up to do the same. Due to our sophisticated monitoring systems and smart automation we are able to identify and fix the issues before they have an effect on your operations. All the interactions will be fast, accurate and transparent so you will always know what is going on and be served. Whether it is a minor correction or a complicated problem, we keep working until your computer systems are functioning optimally without falling into downtime. When you are with TechDevise, you do not have a supporting partner, instead, what you have is a dedicated partner to your business regardless of the time. Otherwise, we are always available as long as you send a message or make a call.
                        </p>
                    )}
                    {isActiveTab === 3 && (
                        <p className='text-[1.125rem] leading-[1.625rem] font-normal lg:text-start text-center'>
                          <strong className='font-semibold'>Tech Devise</strong>   provides excellent quality at affordable prices and this provides every project with the best results without failure to meet your budget. Whether it is mobile applications development or web design, SEO, digital marketing, or automation, every solution will be customized to your goals. It is all about the integration of creativity, technology and efficiency in order to deliver results that translate to quantifiable growth. Planning to delivery is optimized to waste the least amount of time, money and produce high quality results. Clients also enjoy scalable solutions which are aimed to grow with business whether launching a new start-up or improving an established brand. Affordability is not a compromise but it is smarter investments and better returns. Tech Devise gives companies just the right combination of cost savings and quality.
                        </p>
                    )}
                    {isActiveTab === 4 && (
                        <p className='text-[1.125rem] leading-[1.625rem] font-normal lg:text-start text-center'>
                           It is all based on experience. We have established a brand name over the years in providing strategic and result driven innovative digital solutions. Our staff is a cocktail of technical skills, innovative ideas, profound knowledge of the trade trends that help us develop solutions that only fit with the peculiarities of each customer. After 10 years in the industry, we have partnered businesses of all scapes, even the startups; we support startups to scale, established brands to innovate, and organizations to remain competitive in their respective industries in a constantly changing digital world. Our work is geared towards partnership, openness and accountability, with each project bringing a significant and durable value. We will take your ideas, whether they span web development through digital marketing to the most advanced technology tie-ins, and make them happen. Experience to TechDevise means not just time it means being able to bring excellence project after project, client after client.
                        </p>
                    )}
                    {isActiveTab === 5 && (
                        <p className='text-[1.125rem] leading-[1.625rem] font-normal lg:text-start text-center'>
                         Our Flexible Plans would provide you with the opportunity to have full control of your project scope, time, and budget. Our plans are designed to accommodate your specific needs whether you are a startup or established enterprise wishing to scale up, we have the right plans that will suit your needs. There is a range of service plans or personalize and design your own package with the specifications you require. Your plan can be upgraded, put on hold, or modified at any time-so you only pay when it helps your business the most. No surprises in pricing; no more secret fees; a serious support team; and you can schedule with confidence and concentrate on expansion. Whether you are undertaking a short term project or continuing a long-term collaboration, our agile approach enables you to remain nimble in a rapidly evolving digital world so that you can always keep in front of the competition.
                        </p>
                    )}
                </div>
            </div>
