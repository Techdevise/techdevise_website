...
const DigitalMarketingOne = () => {
    ...
    return (
        <>
            ...
            <section style={{ backgroundImage: `url(${seoBg})` }} className='bg-no-repeat bg-cover pt-[5.5625rem] flex items-center justify-center'>
                <div className="main-container">
                    <div className="flex max-md:flex-col items-end justify-between">
                        <div className="w-full max-w-[51.1875rem]">
                            <h1 className="md:text-[3.875rem] text-[3rem] font-extrabold text-transparent bg-clip-text bg-[linear-gradient(90deg,_#FFFFFF_0%,_#EDF5F3_7.5%,_#D4E7E4_17.5%,_#157B6C_95.5%)] mb-7">
                                Renowned <br />
                                SEO Experts
                            </h1>
                            ...
                            <h2 className='text-[clamp(9rem,_13vw,_15.75rem)] text-white font-extrabold opacity-5 leading-none mt-9 mb-4'>SEO</h2>
                        </div>
                        <div className="grow md:max-w-2/5 pt-7">
                            <button className="block text-2xl font-bold leading-none py-2.5 px-11 rounded-xl border-2 border-pine-200 text-white mx-auto">BUSINESS GROWTH</button>
                            <img src={seoRightImage} alt="seoRightImage" className='w-full' />
                        </div>
                    </div>
                </div>
            </section>
