        ...
        <div className="main-container">
          <div className={` h-full flex-1 flex lg:flex-row flex-col  justify-start items-stretch gap-[2.875rem] relative transition-all duration-300 `}>
            ...
            <div className="lg:flex-1 lg:overflow-y-auto">
              ...
              <Link className='bg-pine-700 cursor-pointer w-[15.3125rem] py-2.5 px-5 text-center block text-white rounded-[.625rem]' to={`/career-three/${jobDetails.id}`}>Apply</Link>
            </div>
          </div>
        </div>
      </section>
