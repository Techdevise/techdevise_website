...
const CareerThree = () => {
  ...
  const handleQuestionChange = (id, value) => {
    setInterviewQuestions(
      interviewQuestions.map((q) => (q.id === id ? { ...q, value } : q))
    );
  };
        ...
        <div className="main-container">
          <div className="modal h-full flex-1 relative transition-all duration-300">
            ...
            >
                  ...
                  <div key={question.id} className="relative mb-4">
                    <div className="bg-gradient-to-b from-pine-700/10 to-pine-700/30 rounded-lg p-[1px] mb-4">
                      <textarea
                        ...
                        placeholder={`Interview availability option ${
                          index + 1
                        }`}
                        className="h-[6.875rem] bg-[#fafafa] w-full rounded-[.4375rem] text-[1.125rem] leading-[1.875rem] flex justify-start items-center p-5 placeholder:text-black/30 focus-visible:outline-0 focus-visible:shadow-none"
                      />
              ...
              {/* Location */}
              <div className="md:col-span-2">
                <h5 className="text-[1.125rem] leading-[1.625rem] font-bold mb-3">
                  Are you located in Mohali, Punjab?
                </h5>
                <ul>
                  <li className="flex justify-start items-center gap-2 5">
                    ...
                    <label
                      htmlFor="yes"
                      className="text-sm leading-[1.625rem] font-normal"
                    >
                      Yes
                    </label>
                  </li>
              ...
              <div className="pt-3 md:col-span-2">
                <label
                  htmlFor="check"
                  className="flex justify-start items-start lg:gap-4 gap-2 cursor-pointer max-w-4xl"
                >
                  <input
                    type="checkbox"
                    id="check"
                  ...
                  />
                  <div
                    className={`checkbox bg-[#fafafa] peer-checked:bg-pine-700 size-[2.125rem] rounded-md border-[.0625rem] text-white flex justify-center items-center border-pine-700 aspect-square transition-all duration-300`}
                  >
                  ...
                  <span className="text-base leading-[1.625rem]">
                    ...
                    activities -{" "}
                    <Link to="/Terms-Conditions" className="text-pine-700">
                      Terms & Conditions
                    </Link>
                    .
                  </span>
              ...
              <p className="text-base leading-[1.625rem] font-bold md:col-span-2">
                ...
                updated CV/Resume at hr@techdevise.com
              </p>
