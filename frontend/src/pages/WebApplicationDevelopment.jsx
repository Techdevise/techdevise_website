        ...
        <>
            ...
            <section style={{ backgroundImage: `url(${serviceBg})` }} className="min-h-screen bg-no-repeat bg-cover bg-center flex justify-center items-center">
                <div className="main-container  text-center ">
                    ...
                    <p className="2xl:text-[1.10rem] text-[1rem] font-normal max-w-[64.1875rem] mx-auto text-white mb-[1.375rem]"><b className="font-bold">Tech Devise</b> employs a professional team of experts. Our primary goal is the fulfillment of the needs of our clients. The fact that we still offer to meet the needs of our clients after the delivery period makes it our strength to offer good services.
</p>
            ...
            <section>
                <div className="main-container">
                    <div className="section-header text-center mb-[5.375rem]">
                        <h3 className="2xl:text-[3rem] lg:text-[2.4rem] text-[2rem] font-bold  text-black mb-[1.625rem]">Automation</h3>
                        <p className="2xl:text-[1.10rem] text-[1rem] leading-[1.625rem] font-medium max-w-6xl mx-auto">We are a team of experts! We work together towards the sole goal of meeting our clients&apos; requirements. We promise to deliver high performance service to all of our customers and offer best possible post-delivery support.</p>
                    </div>
                    ...
                    <div className="bg-white rounded-[.625rem] lg:px-[2.9375rem] p-10 lg:py-[5.3125rem] pt-[0] pb-10">
                        <div className="flex xl:flex-row flex-col 2xl:gap-[4.25rem] lg:gap-[3.125rem] gap-10">
                            <div className="flex-1 lg:order-1 order-2">
                                <h2 className="2xl:text-[3rem] lg:text-[2.4rem] text-[2rem] font-bold mb-[1.875rem]">Tech Devise: Creating flexible and easy to work automation solutions
</h2>
...
Python is a high- level programming language because it is expandable and has become one of the simplest codes to learn and apply. Python possesses a diverse library and frame and is widely used in software development programs, data science, automation, web development, and artificial intelligence. Its features amount to its versatility and strength, and being able to deal with difficult applications used by talented workers and large technological firms, but also its easy syntax, rendering it a perfect beginner programming language.
            ...
            <section className="why my-[4.6875rem] pb-10">
                <div className="main-container">
                    <div className="section-header text-center mb-[5.375rem]">
                        <h3 className="2xl:text-[3rem] lg:text-[2.4rem] text-[2rem] font-bold  text-black mb-[1.625rem]">Why Choose Us</h3>
