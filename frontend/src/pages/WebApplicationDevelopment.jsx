...
const WebApplicationDevelopment = () => {
  ...
  const ourWorkList = [
    ...
    },
    {
      ...
      discription:
        "Your CMS site needs content until it is launched. Your first upload is also our responsibility where we ensure your content is uploaded in the right place and without hassles. You will also be in full control of content modification or updating later.",
    },
    {
      bg: "#D0EBFF",
      image: ourWork1,
    ...
    },
    {
      ...
      discription:
        " We intend to offer a quality service by maintaining an affordable price. To ensure your website runs efficiently, we shall also ensure that all the processes involved in the development process are top quality and there should be support even after the project is finished.",
    },
  ];
    ...
    <>
      ...
      <section className="min-h-screen relative flex justify-center items-center overflow-hidden">
        ...
        <div className="relative main-container text-center z-10">
          ...
          <p className="2xl:text-[1.10rem] text-[1rem] font-normal max-w-[64.1875rem] mx-auto text-white mb-[1.375rem]">
            <b className="font-bold">Tech Devise</b> employs a professional team
            of experts. Our primary goal is the fulfillment of the needs of our
            clients. The fact that we still offer to meet the needs of our
      ...
      <section className="my-[4.6875rem]">
        <div className="main-container !pe-0">
          <div className="relative">
            <h4 className="texto max-lg:hidden absolute top-2 left-5 rotate-180 md:text-[50px] lg:text-[42px] xl:text-[52px] 2xl:text-[58px] sm:text-[2.625rem] text-[2.55rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-[#f2f2f2] to-pine-700">
              Our Work Modules
            </h4>
            <div className="lg:ps-[7.125rem] ">
              <div className="section-header flex gap-10 lg:flex-row flex-col justify-between lg:items-center items-stretch main-container !ps-0 max-lg:!pe-10 !max-w-auto">
                <p className="md:text-[20px] text-[12px] leading-[2.1875rem] font-normal max-w-6xl ">
                  <strong>Content Management System</strong> - A content
                  management system allows the users to create, manage, and
                  publish digital content without having to possess high-level
                  technical expertise. It simplifies the maintenance of the
                  sites, teamwork, and lets users come up with the design, SEO,
                ...
                {ourWorkList.map((item, index) => {
                  return (
                    <SwiperSlide key={index} className="">
                      <div
                        className={`bg-[${item.bg}] rounded-[1.625rem] pt-10 px-7 pb-5`}
                      >
                        <div
                          className={`w-[7rem] h-[7rem] rounded-full bg-[${item.roundBg}] flex items-center justify-center mb-[1.8125rem]`}
                        >
      ...
      <section
        style={{ backgroundImage: `url(${webServiceBg1})` }}
        className="e-commerce bg-center bg-cover bg-no-repeat my-[4.6875rem] py-[4.6875rem]"
      >
        <div className="main-container">
          <div className="section-header text-center mb-[5.375rem]">
            ...
            <p className="2xl:text-[1.10rem] text-[1rem] leading-[1.625rem] font-medium max-w-6xl mx-auto">
              {" "}
              We offer our solutions to customers due to our team of experts
              offering personalized and innovative e-commerce services. There is
              no doubt that our E-commerce services will help you realize the
              next level of your company should you want to go digital.
            </p>
          </div>
      ...
      <section>
        <div className="main-container">
          <div className="section-header text-center mb-[5.375rem]">
            ...
            <p className="2xl:text-[1.10rem] text-[1rem] leading-[1.625rem] font-medium max-w-6xl mx-auto">
              We are a team of experts! We work together towards the sole goal
              of meeting our clients&apos; requirements. We promise to deliver
              high performance service to all of our customers and offer best
              possible post-delivery support.
            </p>
          </div>
          ...
          <div className="bg-white rounded-[.625rem] lg:px-[2.9375rem] p-10 lg:py-[5.3125rem] pt-[0] pb-10">
            <div className="flex xl:flex-row flex-col 2xl:gap-[4.25rem] lg:gap-[3.125rem] gap-10">
              <div className="flex-1 lg:order-1 order-2">
                <h2 className="2xl:text-[3rem] lg:text-[2.4rem] text-[2rem] font-bold mb-[1.875rem]">
                  Tech Devise: Creating flexible and easy to work automation
                  solutions
                </h2>
                <p className="2xl:text-[1.10rem] text-[1rem] leading-[2.125rem] font-normal">
                  Being a group of committed individuals of Tech Devise, we
                  specialize and deal with robotic and control systems. We
                  deliver high-tech control solutions with robotization that are
                  highly customized to the individual business requirements of
                  our clients with industries such as the automotive and
                  consumer goods.It does not matter whether you have to install
                  an entirely novel and even highly distinctive control system
                  or you want merely to renew or improve your current automation
                  system, here we are. We can either create the latest robotic
                  systems on the ground up or modify your existing robots to
                  improve performance, cost and speed.We may also provide system
                  relocation services, when you need to move operations to
                  another city or country, we are capable of moving your setup
                  to the destination so easily. Whether your project is large or
                  small, you can rely upon us to produce cost effective and high
                  performance results.{" "}
                </p>
              </div>
              <img
                src={robo}
                alt="robo"
                className="lg:flex-[0_1_25rem] lg:max-w-[25rem] max-w-2xl w-full h-full mx-auto block lg:order-2 order-1"
              />
            </div>
          </div>
        </div>
      ...
      <section className="python my-[4.6875rem] bg-[#EEFCFE] max-lg:py-[4.6875rem]">
        <div className="main-container lg:!ps-0">
          <div
            className={` h-full flex-1 flex lg:flex-row flex-col  justify-start items-center gap-[2.875rem] relative transition-all duration-300 `}
          >
            <img
              src={python}
              alt="modal side image"
              className="lg:max-w-[51.5625rem] lg:max-h-[61.9375rem] lg:h-full h-[25rem] w-full lg:object-cover object-cover rounded-r-[1.625rem]"
            />
            <div className="lg:flex-1 lg:overflow-y-auto">
              <h2 className="2xl:text-[3rem] lg:text-[2.4rem] text-[2rem] font-bold mb-[3.25rem]">
              ...
              <p className="2xl:text-[1.10rem] text-[1rem] leading-[2.125rem] font-normal pb-12">
                ...
                expandable and has become one of the simplest codes to learn and
                apply. Python possesses a diverse library and frame and is
                widely used in software development programs, data science,
                automation, web development, and artificial intelligence. Its
                features amount to its versatility and strength, and being able
                to deal with difficult applications used by talented workers and
                large technological firms, but also its easy syntax, rendering
                it a perfect beginner programming language.
              </p>

              <h4 className="text-[1.75rem] leading-[2.4375rem] font-semibold mb-3">
        ...
        <div className="main-container">
          <div className="section-header text-center mb-[5.375rem]">
            ...
            <p className="2xl:text-[1.10rem] text-[1rem] leading-[1.625rem] font-normal max-w-6xl mx-auto">
              At our team, high performance, scalability, security and agility
              in Website development are the main areas of interest. This
              assists us in generating output to our clients besides addressing
              their requirements. This way, you are most certainly welcome to
              call us or leave an email, in case you are interested in our
              high-quality service at a decent price, and we will do our best to
              fulfill your satisfaction. You will be assured that the work with
              Tech Devise will give you quality support all the time and well
              even after the project delivery.
            </p>
          </div>
          ...
          <img
            src={why1}
            alt="why image"
            className="block mt-[2.375rem] mb-[4.6875rem] rounded-[1.625rem]"
          />

          <div className="flex justify-center items-center lg:flex-row flex-col lg:s-[3.1875rem] relative">
            <h4 className="texto max-lg:hidden absolute top-[113px] text-nowrap 2xl:left-0 lg:-left-10 left-0 rotate-180 sm:text-[1.225rem] text-lg font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-[##666666] to-black">
              Our Work Modules
            </h4>

            <div className="flex-1 lg:order-1 order-2">
              <p className="2xl:text-[1.10rem] text-[1rem] leading-[1.625rem] font-normal max-w-6xl mx-auto">
                <span className="font-bold">Artificial Intelligence</span> as
                you can understand is all about implementing a system that can
                calculate, derive, and take decisions without having to wait for
                human input. All though these days in many field AI is being
                used, but it&apos;s still a new technology in the corporate
                world and requires a lot of implementation capabilities. At Tech
                Devise, we stand as the bridge between the corporate needs and
                the academic knowledge of AI. We implement the data research
                models into machines to offer our clients the right solution for
                their requirement. We have experts in our team of AI and ML.
                From data studies to deployment, we stay with our clients and
                make sure that we deliver them a capable AI-enabled system. We
                team up with data scientists to extract valuable information
                from any existing data present in any company and then optimize
                their business with the help AI and ML. If you wish to build
                scalable ML models that can improve your business progress we
                are definitely with you.
              </p>
            </div>
            <img
              src={why2}
              alt="why 2 vector image"
